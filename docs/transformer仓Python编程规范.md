...
- 注释格式详见[MindSpore注释规范](https://atomgit.com/mindspore/community/blob/master/guidelines/docs_comments_guidelines_zh_cn.md)。
...
<font size=3>**规则 2.2.1 对所有外部数据进行合法性检查，包括但不限于：函数入参、外部输入命令行、文件格式，文件大小、环境变量、用户数据等。**</font>
