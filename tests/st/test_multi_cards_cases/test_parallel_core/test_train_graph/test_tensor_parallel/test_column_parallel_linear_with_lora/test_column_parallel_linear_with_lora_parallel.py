...
from tests.st.test_ut.test_parallel_core.test_training_graph.test_tensor_parallel.test_column_parallel_linear_with_lora.test_column_parallel_linear_with_lora import TestColumnParallelLinearWithLoRA
...
TWO_CARD_TEST_CASES = [
    (
        ...
        {"output": "output_random", "bias": "bias_random"},
        False,
        2
    ),
]

class TestColumnParallelLinearWithLoRATwoCards(TestColumnParallelLinearWithLoRA):
