...
from tests.st.test_ut.test_parallel_core.test_training_graph.test_transformer.test_attention.test_self_attention.test_self_attention_megatron import TestSelfAttentionMegatron


_LEVEL_0_TASK_TIME = 0
_LEVEL_1_TASK_TIME = 90
