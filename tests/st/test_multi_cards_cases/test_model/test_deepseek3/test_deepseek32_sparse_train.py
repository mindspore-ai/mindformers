    ...
    def test_eight_card_configurations(self):
        ...
        cmd_list = [
            (f"msrun --worker_num=8 --local_worker_num=8 --master_port={port_id} "
             f"--log_dir=./msrun_log_deepseekv32_sparse --join=True {self.run_script_path} "
             f"--mode=parallel_train_dsa2_dp2_tp2_cp2_ep4",
             "./msrun_log_deepseekv32_sparse/worker_7.log"),
        ]
