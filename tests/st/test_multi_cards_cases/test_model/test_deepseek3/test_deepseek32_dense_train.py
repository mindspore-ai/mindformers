...
# need to be set before import mindspore
os.environ["MS_DEV_RUNTIME_CONF"] = "inline:False"
...
class TestDeepseekV32Dense:
    """Test class for DeepseekV3.2 dense stage"""
    ...
    def test_eight_card_configurations(self):
        ...
        cmd_list = [
            (f"msrun --worker_num=8 --local_worker_num=8 --master_port={port_id} "
             f"--log_dir=./msrun_log_deepseekv32_dense --join=True {self.run_script_path} "
             f"--mode=parallel_train_dsa1_dp2_tp2_pp2_ep4",
             "./msrun_log_deepseekv32_dense/worker_7.log"),
        ]
