...
from tests.st.test_ut.test_pynative.test_transformers.test_multi_latent_attention.data_gen_utils import get_init_params
...
class MLARunner:
    ...
    def run(self):
        ...
        hidden_state, _, mind_weight, attention_mask, rotary_pos_emb = get_init_params(
            0.0,
            0.15,
            self.config,
        ...
        weight = mind_weight # mind_weight is concatenated weight
        for k in weight:
