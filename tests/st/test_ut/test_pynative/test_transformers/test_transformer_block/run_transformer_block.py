...
from mindformers.pynative.transformers.transformer_layer import TransformerLayerSubmodules, \
    TransformerLayer
from mindformers.pynative.transformers.transformer_block import TransformerBlock
from mindformers.pynative.layers.layer_norm import FusedLayerNorm
from mindformers.pynative.transformers.attention import SelfAttention, \
...
class TransformerLayerRunner:
    ...
    def __init__(self, args_from_parser):
        ...
        # Parallelism (for config only, no actual parallel initialization)
        ...
        submodules = TransformerLayerSubmodules(
            input_layernorm=MODULE_MAP[self.args.input_layernorm],
