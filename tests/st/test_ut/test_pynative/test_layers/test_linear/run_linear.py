...
# ============================================================================
"""Run Linear accuracy test with configurable parameters via args"""
import argparse
import os
...
class LinearRunner:
    """Class to manage Linear model and weights"""
    ...
    def build_model(self):
        """Build and initialize Linear model"""
        net = Linear(
...
def main():
    parser = argparse.ArgumentParser(description="Run Linear test")
