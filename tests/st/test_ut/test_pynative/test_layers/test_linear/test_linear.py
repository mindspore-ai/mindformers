...
# ============================================================================
"""Test Linear with various configurations"""
...
class TestLinearSingleCard(TestLinear):
    """Test class for Linear with single card configurations"""
    @pytest.mark.level0
