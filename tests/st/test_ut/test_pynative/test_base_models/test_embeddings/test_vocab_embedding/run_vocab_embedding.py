...
# ============================================================================
"""Run VocabEmbedding accuracy test with configurable parameters via args"""
import argparse
import os
...
class VocabEmbeddingRunner:
    """Class to manage VocabEmbedding model and weights"""
    ...
    def build_model(self):
        """Build and initialize VocabEmbedding model"""
        net = VocabEmbedding(
...
def main():
    parser = argparse.ArgumentParser(description="Run VocabEmbedding test")
    ...
    # Prepare input
    runner = VocabEmbeddingRunner(args)
    runner.run()
