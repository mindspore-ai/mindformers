...
# ============================================================================
"""Run ColumnParallelLinearWithLoRA accuracy test with configurable parameters via args"""
import argparse
import os
...
from mindformers.parallel_core.training_graph.tensor_parallel.lora_layers import ColumnParallelLinearWithLoRA
...
class ColumnParallelLinearWithLoRARunner:
    """Class to manage ColumnParallelLinearWithLoRA model and weights"""
    ...
    def build_model(self):
        """Build and initialize ColumnParallelLinearWithLoRA model"""
        net = ColumnParallelLinearWithLoRA(
...
def main():
    parser = argparse.ArgumentParser(description="Run ColumnParallelLinearWithLoRA test")
    ...
    # Prepare input
    runner = ColumnParallelLinearWithLoRARunner(args)
    runner.run()
