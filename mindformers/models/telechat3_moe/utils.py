...
# ============================================================================
"""TeleChat3 models' utils."""
import mindspore as ms

from mindformers.models.modeling_utils import PreTrainedModel
from mindformers.parallel_core.utils.model_mixin import ModelMixin
from mindformers.models.telechat3_moe.configuration_telechat3_moe import TeleChat3MoeConfig


class TeleChat3MoePreTrainedModel(PreTrainedModel, ModelMixin):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.
    """

    config_class = TeleChat3MoeConfig
    base_model_prefix = "TeleChat3"
    ...
    weight_mapping = [
        ...
        # mtp layer: for telechat3, only layer 46`
        ('model.layers.46.enorm.', 'decoder.enorm.'),
        ('model.layers.46.hnorm.', 'decoder.hnorm.'),
        ('model.layers.46.eh_proj.', 'decoder.eh_proj.'),
        ('model.layers.46.embed_tokens.', 'embedding.word_embeddings.'),
        ('model.layers.46.shared_head.norm.', 'decoder.final_layernorm.'),
        ('model.layers.46.shared_head.head.', 'output_layer.'),
        ('model.layers.46.', 'decoder.transformer.'),
        # transformer layers
