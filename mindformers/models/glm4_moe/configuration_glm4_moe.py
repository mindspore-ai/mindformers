...
@MindFormerRegister.register(MindFormerModuleType.CONFIG, legacy=False, search_names='glm4_moe')
class Glm4MoeConfig(PretrainedConfig):
    ...
    Args:
        ...
        topk_group (`int`, *optional*, defaults to 1):
            Number of selected groups for each token(for each token, ensuring the selected experts is only
            within `topk_group` groups).
