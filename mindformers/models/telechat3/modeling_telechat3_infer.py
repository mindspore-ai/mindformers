...
# ============================================================================
"""Telechat3 models' APIs."""
__all__ = ['InferenceTelechat3ForCausalLM']
...
class InferenceTelechat3ForCausalLM(TeleChat3PreTrainedModel, InferModelMixin):
    """
    Provide telechat3 model infer through network.

    Args:
        config (Telechat3Config): The config of telechat3 model.

    Returns:
        output: Tensor, the output of telechat3 decoder layer
