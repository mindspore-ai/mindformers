...
@MindFormerRegister.register(MindFormerModuleType.CONFIG, legacy=False, search_names='telechat')
class Telechat2Config(PretrainedConfig):
    ...
    Args:
        ...
        layer_norm_epsilon (`float`, *optional*, defaults to 1e-5): The epsilon to use in the layer
        normalization layers.
        initializer_range (`float`, *optional*, defaults to 0.02): The standard deviation of the
        truncated_normal_initializer for initializing all weight matrices.
        apply_residual_connection_post_layernorm (`bool`, *optional*, defaults to `False`): If enabled,
        use the layer norm of the hidden states as the residual in the transformer blocks
        ...
        use_cache (`bool`, *optional*, defaults to `True`): Whether or not the model should return
        the last key/values attentions.
    ...
    @ignore_and_delete_parameter(extra_ignore_param=[
        ...
        ('n_inner', NotSupportedInfo.useless),
        ('offset_alibi', NotSupportedInfo.useless),
        ('pretraining_tp', NotSupportedInfo.useless),
        ('skip_bias_add', NotSupportedInfo.useless),
        ('skip_bias_add_qkv', NotSupportedInfo.useless),
        ('slow_but_exact', NotSupportedInfo.useless),
