...
def get_module(spec_or_module: Union[ModuleSpec, type], **additional_kwargs):
    """Return the module class or function a spec (or module) refers to, importing it if given by path."""
    del additional_kwargs  # accepted for Megatron API compatibility; not used
...
def build_module(spec_or_module: Union[ModuleSpec, type], *args, **kwargs):
    """Instantiate the module a spec refers to with the spec's params and the given args, or return a function as is."""
