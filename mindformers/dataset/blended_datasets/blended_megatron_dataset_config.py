...
class BlendedMegatronDatasetConfig:
    ...
    """The PreTrainedTokenizerBase instance or None. Required for datasets which do online tokenization."""

    eod: int = -1
    """The end of document token id."""
    ...
    def __post_init__(self) -> None:
        ...
        if self.blend_per_split is not None and any(self.blend_per_split):
            ...
            logger.warning(f"Let split_matrix = {self.split_matrix}")
