...
| 模型        | 规格                                                                                                                                                                                                           |
|-----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| TeleChat3 | [TeleChat3\-36B](https://gitcode.com/mindspore/mindformers/blob/r1.9.0/configs/telechat3)（预训练、推理）、[TeleChat3\-105B\-A4.7B](https://gitcode.com/mindspore/mindformers/blob/r1.9.0/configs/telechat3_moe)（预训练） |
