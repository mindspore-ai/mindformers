...
|  历史版本   |         1.8.0          |   2.7.2   |  8.5.0  |  25.5.0  |
|  历史版本   |         1.7.0          |   2.7.1   | 8.3.RC1 | 25.3.RC1 |
...
MindSpore Transformers 提供了推理任务的配置文件[predict_glm4_moe.yaml](https://atomgit.com/mindspore/mindformers/blob/master/configs/glm4_moe/predict_glm4_moe.yaml)，用户可以根据实际情况修改此配置文件中的权重路径和其他参数。
